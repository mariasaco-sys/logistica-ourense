...
st.markdown("Calcula rutas y asigna días de reparto según tu histórico de pedidos.")

# --- 0. DATOS HISTÓRICOS (INCRUSTADOS) ---
# Aquí he pegado los datos que me has pasado para que funcionen sin subir excel
